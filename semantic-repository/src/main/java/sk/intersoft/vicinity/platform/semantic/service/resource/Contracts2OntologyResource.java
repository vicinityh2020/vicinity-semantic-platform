...
public class Contracts2OntologyResource extends ServerResource {
    final static Logger logger = LoggerFactory.getLogger(Contracts2OntologyResource.class.getName());
    ...
    public String create(Representation entity) throws Exception {
        ...
        logger.info("=============================");
        logger.info("=============================");
        logger.info("EXECUTE Contracts2Ontology CREATE");
        ...
        try{
            ...
            JSONObject result = handler.createContracts(payload);
